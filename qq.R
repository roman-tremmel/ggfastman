...
qq_fast(big_gwas_data$pvalue, speed = "ult", inflation_method = "reg")


# -----------------------------------------------------------------------
# QQ-plot function
# -----------------------------------------------------------------------
qq_fast <- function(pvalue,linecolor="deeppink",ci_color="steelblue",ci_alpha = 0.3,conf.alpha=.05,
...
qq_fast(gwas_data$pvalue, inflation_method = "med", title = "sdlkfj")
